...
mod tests {
    ...
    fn replaces_unidiomatic_foundation_and_ogden_examples() {
        ...
        assert_eq!(reviewed_stage_template("son").expect("son template").2, "The man has a son.");
        ...
        assert_eq!(reviewed_stage_template("work").expect("work template").2, "I do this work.");
        assert_eq!(reviewed_stage_template("need").expect("need template").2, "There is a need.");
        assert_eq!(reviewed_stage_template("sex").expect("sex template").2, "This form has a line for sex.");
        assert_eq!(
